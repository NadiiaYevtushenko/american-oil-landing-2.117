( () => {
        ...
        3018: (e, t, r) => {
            ...
            e.exports = class {
                constructor(e) {
                    ...
                    if (this[o] = "function" != typeof t ? naiveLength : t,
                    this[l] = e.stale || !1,
                ...
                reset() {
                    this[h] && this[c] && this[c].length && this[c].forEach((e => this[h](e.key, e.value))),
                    this[d] = new Map,
                    this[c] = new n,
                    this[s] = 0
                }
                dump() {
                    return this[c].map((e => !isStale(this, e) && {
                        k: e.key,
                        v: e.value,
                        e: e.now + (e.maxAge || 0)
                    })).toArray().filter((e => e))
                ...
                set(e, t, r) {
                    ...
                    if (this[d].has(e)) {
                        if (l > this[i])
                            return del(this, this[d].get(e)),
                            !1;
                        const o = this[d].get(e).value;
                        return this[h] && (this[u] || this[h](e, o.value)),
                        o.now = n,
                        o.maxAge = r,
                        o.value = t,
                        this[s] += l - o.length,
                    ...
                    return f.length > this[i] ? (this[h] && this[h](e, t),
                    !1) : (this[s] += f.length,
                    this[c].unshift(f),
    ...
    ( () => {
        const esm_compareVersions = (e, t) => {
            ...
            return 0 !== o ? o : i && s ? compareSegments(i.split("."), s.split(".")) : i || s ? i ? -1 : 1 : 0
        }
          ...
          , compareStrings = (e, t) => {
            if (isWildcard(e) || isWildcard(t))
                return 0;
            const [r,n] = ( (e, t) => typeof e != typeof t ? [String(e), String(t)] : [e, t])(tryParse(e), tryParse(t));
        ...
        function getIsReloadAndProfileSupported() {
            ...
            return e && !!(window.document && window.document.featurePolicy && window.document.featurePolicy.allowsFeature("sync-xhr"))
        }
        ...
        function registerRenderer(e, t) {
            ...
            hasAssignedBackend(r) || (r = a),
            t.backends.has(r) || u.add(r)
        }
        function activateBackend(e, t) {
            const r = t.backends.get(e);
            if (!r)
                throw new Error(`Could not find backend for version "${e}"`);
            const {Agent: n, Bridge: l, initBackend: a, setupNativeStyleEditor: h} = r
              , c = new l({
                listen(e) {
                    const listener = t => {
            ...
            "function" == typeof h && t.resolveRNStyle && h(c, d, t.resolveRNStyle, t.nativeStyleEditorValidAttributes),
            c.send("extensionBackendInitialized"),
            u.delete(e)
        }
        function updateRequiredBackends() {
            0 !== u.size && window.postMessage({
                source: "react-devtools-backend-manager",
                payload: {
                    type: "require-backends",
                    versions: Array.from(u)
                }
            }, "*")
        }
        window.__REACT_DEVTOOLS_BACKEND_MANAGER_INJECTED__ || (window.__REACT_DEVTOOLS_BACKEND_MANAGER_INJECTED__ = !0,
        window.addEventListener("message", (function welcome(e) {
            e.source === window && "react-devtools-content-script" === e.data.source && (h ? console.warn('React DevTools detected duplicate welcome "message" events from the content script.') : (h = !0,

    ...
    15773: (t, e, n) => {
        ...
        s.prototype.text = function(t, e) {
            var n = function(t, e, n) {
                ...
                i) : --r < n || -2 === i ? 0 : (i = o(e[r])) >= 0 ? (i > 0 && (t.lastNeed = i - 2),
                i) : --r < n || -2 === i ? 0 : (i = o(e[r])) >= 0 ? (i > 0 && (2 === i ? i = 0 : t.lastNeed = i - 3),
                i) : 0
            }(this, t, e);
            if (!this.lastNeed)
    ...
    69319: t => {
        ...
        t.exports.once = function(t, e) {
            return new Promise(function(n, r) {
                var i, s, o;
                function a(n) {
                    t.removeListener(e, u),
                    r(n)
                }
                function u() {
                    "function" == typeof t.removeListener && t.removeListener("error", a),
                ...
                "function" == typeof i.on && d(i, "error", s, o))
            }
            )
        }
        ,
        ...
        function l(t, e, n, r) {
            ...
            (i = u(t)) > 0 && o.length > i && !o.warned) {
                o.warned = !0;
                var i, s, o, l = Error("Possible EventEmitter memory leak detected. " + o.length + " " + String(e) + " listeners added. Use emitter.setMaxListeners() to increase limit");
        ...
        function c(t, e, n) {
            ...
            return void 0 === i ? [] : "function" == typeof i ? n ? [i.listener || i] : [i] : n ? function(t) {
                for (var e = Array(t.length), n = 0; n < e.length; ++n)
        ...
        s.prototype.emit = function(t) {
            ...
            if ("function" == typeof u)
                ...
                for (var l = u.length, h = v(u, l), n = 0; n < l; ++n)
                    r(h[n], this, e);
            return !0
        }
        ,
